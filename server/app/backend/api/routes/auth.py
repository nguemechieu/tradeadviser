...
async def me(
    ...
    user_data = user.as_public_dict()
    
    # Add comprehensive account information
    account_info = {
        "user": user_data,
        "account": {
            ...
            "account_value": round(float(user.cash_balance or 0.0), 2),  # Would be portfolio value in real app
        },
        "stats": {
